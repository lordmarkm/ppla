      ...
      return {
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
          ...
          scope.toggleCalendar = function(show) {
            if (typeof scope.readonly === 'function' && scope.readonly()) {
              return false;
            }
            if (isFinite(show)) {
